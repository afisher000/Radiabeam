...
% This m-file sets up the GUI items, such as buttons, etc.
    ...
    h.rootdir = 'C:\Users\Marcos\Desktop\GRIT PM images\'; % This is the root directory for saving images
    ...
    % WANT TO ORDER BY DATE FIRST, THEN CAMERA?!

    %% Create Directories
    h.df = strcat(h.rootdir, h.Tag, '\', day);
    h.dfc = strcat(h.rootdir, h.Tag, '\', day, '\Color');
